...
public class EffMysqlSetDatabase extends Effect{

	static {
		RegisterManager.registerEffect(
				EffMysqlSetDatabase.class,
				"[mor.]set mysql database id %string% to %string%"
		);
	}
    ...
    protected void execute(final Event e) {
    	if (this.id.getSingle(e) != null && this.value.getSingle(e) != null){
    		MysqlStaticManager.setDatabase(id.getSingle(e), value.getSingle(e));
    	}
    }
